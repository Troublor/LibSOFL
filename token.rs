...
pub mod erc20_token {
    const _: () = {
        ::core::include_bytes!(
            "/Users/troublor/Developer/Research/LibSOFL/assets/uniswap_v2_router02.abi.json"
        );
    };
    #[rustfmt::skip]
    ...
    impl ::core::convert::From<WethCall> for ERC20TokenCalls {
        fn from(value: WethCall) -> Self {
            Self::Weth(value)
        }
    }
    impl ::core::convert::From<AddLiquidityCall> for ERC20TokenCalls {
        fn from(value: AddLiquidityCall) -> Self {
            Self::AddLiquidity(value)
        }
    }
    impl ::core::convert::From<AddLiquidityETHCall> for ERC20TokenCalls {
        fn from(value: AddLiquidityETHCall) -> Self {
            Self::AddLiquidityETH(value)
        }
    }
    impl ::core::convert::From<FactoryCall> for ERC20TokenCalls {
        fn from(value: FactoryCall) -> Self {
            Self::Factory(value)
        }
    }
    impl ::core::convert::From<GetAmountInCall> for ERC20TokenCalls {
        fn from(value: GetAmountInCall) -> Self {
            Self::GetAmountIn(value)
        }
    }
    impl ::core::convert::From<GetAmountOutCall> for ERC20TokenCalls {
        fn from(value: GetAmountOutCall) -> Self {
            Self::GetAmountOut(value)
        }
    }
    impl ::core::convert::From<GetAmountsInCall> for ERC20TokenCalls {
        fn from(value: GetAmountsInCall) -> Self {
            Self::GetAmountsIn(value)
        }
    }
    impl ::core::convert::From<GetAmountsOutCall> for ERC20TokenCalls {
        fn from(value: GetAmountsOutCall) -> Self {
            Self::GetAmountsOut(value)
        }
    }
    impl ::core::convert::From<QuoteCall> for ERC20TokenCalls {
        fn from(value: QuoteCall) -> Self {
            Self::Quote(value)
        }
    }
    impl ::core::convert::From<RemoveLiquidityCall> for ERC20TokenCalls {
        fn from(value: RemoveLiquidityCall) -> Self {
            Self::RemoveLiquidity(value)
        }
    }
    impl ::core::convert::From<RemoveLiquidityETHCall> for ERC20TokenCalls {
    ...
    impl ::core::convert::From<RemoveLiquidityETHWithPermitCall> for ERC20TokenCalls {
    ...
    impl ::core::convert::From<RemoveLiquidityWithPermitCall> for ERC20TokenCalls {
        fn from(value: RemoveLiquidityWithPermitCall) -> Self {
            Self::RemoveLiquidityWithPermit(value)
        }
    }
    impl ::core::convert::From<SwapETHForExactTokensCall> for ERC20TokenCalls {
        fn from(value: SwapETHForExactTokensCall) -> Self {
            Self::SwapETHForExactTokens(value)
        }
    }
    impl ::core::convert::From<SwapExactETHForTokensCall> for ERC20TokenCalls {
    ...
    impl ::core::convert::From<SwapExactTokensForETHCall> for ERC20TokenCalls {
    ...
    impl ::core::convert::From<SwapExactTokensForTokensCall> for ERC20TokenCalls {
    ...
    impl ::core::convert::From<SwapTokensForExactETHCall> for ERC20TokenCalls {
        fn from(value: SwapTokensForExactETHCall) -> Self {
            Self::SwapTokensForExactETH(value)
        }
    }
    impl ::core::convert::From<SwapTokensForExactTokensCall> for ERC20TokenCalls {
